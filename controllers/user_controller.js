...
exports.getFullName = asyncHandler(async (req, res, next) => {
    const query = await User.findById(req.params.uid).select('fullName').exec();
...
exports.getProfilePicture = asyncHandler(async (req, res, next) => {
    const query = await User.findById(req.params.uid).select('pic').exec();
...
exports.getUserAge = asyncHandler(async (req, res, next) => {
    const query = await User.findById(req.params.uid).select('age').exec();
